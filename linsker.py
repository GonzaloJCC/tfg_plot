...
ax_i.plot(df_plot['Time'], df_plot['i1'], label='i1', color='red', lw=0.7)
ax_i.plot(df_plot['Time'], df_plot['i2'], label='i2', color='purple', lw=0.7)
...
# --- PANEL 2: Pesos (w1, w2) ---
ax_w.plot(df_plot['Time'], df_plot['w1'], label='w1', color='brown', lw=1)
ax_w.plot(df_plot['Time'], df_plot['w2'], label='w2', color='darkgreen', lw=1)
